...
public enum ModArmorMaterials implements ArmorMaterial {
    VINTAGE_SPECS("vintage_specs", 5, new int[]{0, 0, 0, 0,}, 25,
            SoundEvents.ARMOR_EQUIP_GENERIC, 0.0f, 0.0f, () -> Ingredient.of(Items.GLASS_PANE));
    ...
    public String getName() {
        return TombRaider.MOD_ID + ":" + this.name;
    }
